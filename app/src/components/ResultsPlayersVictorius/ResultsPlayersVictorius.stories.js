import ResultsPlayersVictorius from '.';
...
export default {
	title: 'Results/Players Victorius',
	component: ResultsPlayersVictorius,
};

const Template = (args, { argTypes }) => ({
	components: { ResultsPlayersVictorius },
	props: Object.keys(argTypes),
	template:  `
		<results-players-victorius v-bind="$props" />
	`,
});
