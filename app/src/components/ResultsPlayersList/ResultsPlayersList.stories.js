import ResultsPlayersList from '.';
...
export default {
	title: 'Results/Players List',
	component: ResultsPlayersList,
};

const Template = (args, { argTypes }) => ({
	components: { ResultsPlayersList, ResultsPlayer },
	props: Object.keys(argTypes),
	template:  `
		<results-players-list v-bind="$props">
